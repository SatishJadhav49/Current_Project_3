...
namespace QualityAPI.Models
{
    ...
    public partial class MM_FY_Target_Master
    {
        public decimal FY_Target_ID { get; set; }
        public Nullable<decimal> FY_Name { get; set; }
        public Nullable<decimal> FY_Target_L3 { get; set; }
        public Nullable<decimal> FY_Target_L4 { get; set; }
